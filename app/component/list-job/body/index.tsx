...
<<<<<<< HEAD
  ...
  // 1. Quản lý trạng thái phân trang (12 items / trang)
...
<<<<<<< HEAD
  // 2. Reset về trang 1 mỗi khi searchQuery thay đổi
  useEffect(() => {
    setCurrentPage(1);
    if (searchQuery.trim()) {
      dispatch(fetchJobsByName(searchQuery.trim()));
    } else {
...
<<<<<<< HEAD
        {/* Header hiển thị tổng số dịch vụ và từ khóa */}
...
<<<<<<< HEAD
              {searchQuery.trim()
                ? `Không tìm thấy công việc phù hợp với từ khóa "${searchQuery}".`
        ...
        {/* Render danh sách công việc (Chỉ hiển thị 12 item của trang hiện tại) */}
=======
